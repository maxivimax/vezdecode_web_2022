        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-11 w-11" src="../assets/logo.png" alt="Workflow" />
            </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" :src="user.imageUrl" alt="Cool Tester avatar" />
            </div>
            <div class="ml-3">
...
const user = {
  name: 'Крутой Тестировщик',
  email: 'CoolTester@gov.ru',
  imageUrl:
    'https://sun9-47.userapi.com/impf/AMxEJ08L_I0iryYiFJ98gUrWsnTYjY2A3J_Igg/jygwS4KHx8w.jpg?size=495x495&quality=95&sign=bec41d613f1bf1b539ebe0d227f3487e&type=album',
}
const navigation = [
  { name: 'Главная', href: '#', current: true },
  { name: 'Склад', href: '#', current: false },
  { name: 'Витрина', href: '#', current: false },
]
